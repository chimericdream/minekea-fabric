...
import com.chimericdream.minekea.block.displaycases.entity.StrippedCrimsonDisplayCaseBlockEntity;
...
public class StrippedCrimsonDisplayCase extends GenericDisplayCase {
    public static final Identifier BLOCK_ID = new Identifier(ModInfo.MOD_ID, "displaycases/stripped_crimson_display_case");

    @Override
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new StrippedCrimsonDisplayCaseBlockEntity(pos, state);
    }
