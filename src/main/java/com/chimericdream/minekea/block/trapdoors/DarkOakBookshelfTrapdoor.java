...
public class DarkOakBookshelfTrapdoor extends PublicTrapdoorBlock {
    public static final Identifier BLOCK_ID = new Identifier(ModInfo.MOD_ID, "bookshelves/trapdoors/dark_oak_bookshelf_trapdoor");

    public DarkOakBookshelfTrapdoor() {
