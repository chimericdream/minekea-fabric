...
//
//public abstract class MinekeaBlockSettings<T extends MinekeaBlockSettings<?>> extends AbstractBlock.Settings {
...
//        this(AbstractBlock.Settings.copy(block));
//
...
//        String name = Registries.ITEM.get(ingredient).getName().getString();
//
//        if (this.name != null) {
//            name = this.name;
//        }
...
//        this.materials.put(key, Identifier.of(value));
//        // noinspection unchecked
//        return (T) this;
//    }
//
...
//                return Identifier.of(this.bookshelfId);
//            }
//
...
//                return Identifier.of(this.bookshelfModel);
//            }
//
//            return null;
//        }
