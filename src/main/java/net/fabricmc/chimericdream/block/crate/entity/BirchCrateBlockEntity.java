...
import net.fabricmc.chimericdream.screen.crate.BirchCrateScreenHandler;
...
public class BirchCrateBlockEntity extends BlockEntity implements NamedScreenHandlerFactory, ImplementedInventory {
    ...
    public ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
        ...
        return new BirchCrateScreenHandler(syncId, playerInventory, this);
    }
