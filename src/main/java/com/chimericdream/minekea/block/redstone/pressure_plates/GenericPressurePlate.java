...
//    private final BlockSetType.ActivationRule type;
//
//    static {
...
//
//        Identifier PRESSED_MODEL_ID = Identifier.of(BASE_MODEL_ID + "_down");
//
...
//        private BlockSetType.ActivationRule type = EVERYTHING;
//
...
//        public Identifier getBlockId() {
//            if (blockId == null) {
//                blockId = Identifier.of(ModInfo.MOD_ID, String.format("%sredstone/pressure_plates/%s", ModInfo.getModPrefix(modId), mainMaterial));
//            }
//
//            return blockId;
//        }
