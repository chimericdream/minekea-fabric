...
//        Registry.register(Registries.BLOCK, ((CoverSettings) this.settings).getBlockId(), this);
//        Registry.register(Registries.ITEM, ((CoverSettings) this.settings).getBlockId(), new BlockItem(this, new Item.Settings().group(ItemGroups.COVERS)));
//
//        if (isFlammable) {
...
//        public Identifier getBlockId() {
//            if (blockId == null) {
//                blockId = Identifier.of(ModInfo.MOD_ID, String.format("%sbuilding/covers/%s", ModInfo.getModPrefix(modId), mainMaterial));
//            }
//
//            return blockId;
//        }
