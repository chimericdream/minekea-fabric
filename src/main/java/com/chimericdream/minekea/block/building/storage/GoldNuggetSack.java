...
public class GoldNuggetSack extends GenericStorageBlock {
    public GoldNuggetSack() {
        super(new BlockConfig().settings(AbstractBlock.Settings.copy(Blocks.GOLD_BLOCK).sounds(BlockSoundGroup.METAL)).item(StorageBlocks.GOLD_NUGGET_BAG).material("gold_nugget"), true);
    }
