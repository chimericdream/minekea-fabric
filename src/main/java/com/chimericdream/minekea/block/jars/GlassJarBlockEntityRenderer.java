...
public class GlassJarBlockEntityRenderer implements BlockEntityRenderer<GlassJarBlockEntity> {
    ...
    private void renderFluidTexture(
        ...
        // east (x+)
        translucentBuffer
            .vertex(worldMatrix.getModel(), 1f - HORIZONTAL_OFFSET, 0f, 1f - HORIZONTAL_OFFSET)
            ...
            .next();
        translucentBuffer
            .vertex(worldMatrix.getModel(), 1f - HORIZONTAL_OFFSET, 0f, 0f + HORIZONTAL_OFFSET)
            .color(xColorR, xColorG, xColorB, 1f)
            ...
            .next();
        translucentBuffer
            .vertex(worldMatrix.getModel(), 1f - HORIZONTAL_OFFSET, fY, 0f + HORIZONTAL_OFFSET)
            .color(xColorR, xColorG, xColorB, 1f)
            ...
            .next();
        translucentBuffer
            .vertex(worldMatrix.getModel(), 1f - HORIZONTAL_OFFSET, fY, 1f - HORIZONTAL_OFFSET)
            .color(xColorR, xColorG, xColorB, 1f)
        ...
        // west (x-)
        translucentBuffer
            .vertex(worldMatrix.getModel(), 0f + HORIZONTAL_OFFSET, 0f, 0f + HORIZONTAL_OFFSET)
            .color(xColorR, xColorG, xColorB, 1f)
            .texture(texture.getMinU(), texture.getMinV())
            .light(light)
            .normal(-1f, 0f, 0f)
            .next();
        translucentBuffer
            .vertex(worldMatrix.getModel(), 0f + HORIZONTAL_OFFSET, 0f, 1f - HORIZONTAL_OFFSET)
            .color(xColorR, xColorG, xColorB, 1f)
            .texture(texture.getMaxU(), texture.getMinV())
            .light(light)
            .normal(-1f, 0f, 0f)
            .next();
        translucentBuffer
            .vertex(worldMatrix.getModel(), 0f + HORIZONTAL_OFFSET, fY, 1f - HORIZONTAL_OFFSET)
            .color(xColorR, xColorG, xColorB, 1f)
            .texture(texture.getMaxU(), texture.getFrameV(fillLevel))
            .light(light)
            .normal(-1f, 0f, 0f)
            .next();
        translucentBuffer
            .vertex(worldMatrix.getModel(), 0f + HORIZONTAL_OFFSET, fY, 0f + HORIZONTAL_OFFSET)
            .color(xColorR, xColorG, xColorB, 1f)
            .texture(texture.getMinU(), texture.getFrameV(fillLevel))
            .light(light)
            .normal(-1f, 0f, 0f)
        ...
        // up (y+)
        translucentBuffer
            .vertex(worldMatrix.getModel(), 0f + HORIZONTAL_OFFSET, fY - NUDGE, 1f - HORIZONTAL_OFFSET)
            ...
            .next();
        translucentBuffer
            .vertex(worldMatrix.getModel(), 1f - HORIZONTAL_OFFSET, fY - NUDGE, 1f - HORIZONTAL_OFFSET)
            .color(colorR, colorG, colorB, 1f)
            .texture(texture.getMaxU(), texture.getMinV())
            .light(light)
            .normal(0f, 1f, 0f)
            .next();
        translucentBuffer
            .vertex(worldMatrix.getModel(), 1f - HORIZONTAL_OFFSET, fY - NUDGE, 0f + HORIZONTAL_OFFSET)
            .color(colorR, colorG, colorB, 1f)
            ...
            .next();
        translucentBuffer
            .vertex(worldMatrix.getModel(), 0f + HORIZONTAL_OFFSET, fY - NUDGE, 0f + HORIZONTAL_OFFSET)
            .color(colorR, colorG, colorB, 1f)
        ...
        // down (y-)
        translucentBuffer
            .vertex(worldMatrix.getModel(), 0f + HORIZONTAL_OFFSET, 0f + NUDGE, 0f + HORIZONTAL_OFFSET)
            ...
            .next();
        translucentBuffer
            .vertex(worldMatrix.getModel(), 1f - HORIZONTAL_OFFSET, 0f + NUDGE, 0f + HORIZONTAL_OFFSET)
            .color(yColorR, yColorG, yColorB, 1f)
            .texture(texture.getMaxU(), texture.getMinV())
            .light(light)
            .normal(0f, -1f, 0f)
            .next();
        translucentBuffer
            .vertex(worldMatrix.getModel(), 1f - HORIZONTAL_OFFSET, 0f + NUDGE, 1f - HORIZONTAL_OFFSET)
            .color(yColorR, yColorG, yColorB, 1f)
            .texture(texture.getMaxU(), texture.getMaxV())
            .light(light)
            .normal(0f, -1f, 0f)
            .next();
        translucentBuffer
            .vertex(worldMatrix.getModel(), 0f + HORIZONTAL_OFFSET, 0f + NUDGE, 1f - HORIZONTAL_OFFSET)
            .color(yColorR, yColorG, yColorB, 1f)
            .texture(texture.getMinU(), texture.getMaxV())
            .light(light)
            .normal(0f, -1f, 0f)
