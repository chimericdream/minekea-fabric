...
public class JungleBookshelfTrapdoor extends PublicTrapdoorBlock {
    public static final Identifier BLOCK_ID = new Identifier(ModInfo.MOD_ID, "bookshelves/trapdoors/jungle_bookshelf_trapdoor");

    public JungleBookshelfTrapdoor() {
