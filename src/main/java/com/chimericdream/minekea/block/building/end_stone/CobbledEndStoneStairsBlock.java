...
public class CobbledEndStoneStairsBlock extends StairsBlock implements MinekeaBlock {
    public static final Identifier BLOCK_ID = new Identifier(ModInfo.MOD_ID, "building/cobbled_end_stone_stairs");

    public CobbledEndStoneStairsBlock() {
        super(Blocks.END_STONE_BRICK_STAIRS.getDefaultState(), FabricBlockSettings.copyOf(Blocks.END_STONE_BRICK_STAIRS));
    }
