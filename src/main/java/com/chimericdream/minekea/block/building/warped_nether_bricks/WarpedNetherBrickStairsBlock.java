...
public class WarpedNetherBrickStairsBlock extends StairsBlock implements MinekeaBlock {
    public static final Identifier BLOCK_ID = new Identifier(ModInfo.MOD_ID, "building/warped_nether_brick_stairs");

    public WarpedNetherBrickStairsBlock() {
        super(Blocks.NETHER_BRICK_STAIRS.getDefaultState(), FabricBlockSettings.copyOf(Blocks.RED_NETHER_BRICKS));
    }
    ...
    public void setupResources() {
        ...
        MinekeaResourcePack.RESOURCE_PACK.addRecipe(
            ...
            JRecipe.shaped(
                JPattern.pattern("#  ", "## ", "###"),
                JKeys.keys()
                    .key("#", JIngredient.ingredient().item(WarpedNetherBricksBlock.BLOCK_ID.toString())),
