...
public class CobbledEndStoneSlabBlock extends SlabBlock implements MinekeaBlock {
    public static final Identifier BLOCK_ID = new Identifier(ModInfo.MOD_ID, "building/cobbled_end_stone_slab");

    public CobbledEndStoneSlabBlock() {
        super(FabricBlockSettings.copyOf(Blocks.END_STONE_BRICK_SLAB));
    }
    ...
    public void setupResources() {
        ...
        Identifier DOUBLE_MODEL_ID = Model.getItemModelID(CobbledEndStoneBlock.BLOCK_ID);
        ...
        MinekeaResourcePack.RESOURCE_PACK.addRecipe(
            ...
            JRecipe.shaped(
                JPattern.pattern("###"),
                JKeys.keys().key("#", JIngredient.ingredient().item(CobbledEndStoneBlock.BLOCK_ID.toString())),
        ...
        String warpedBricksTexture = Texture.getBlockTextureID(CobbledEndStoneBlock.BLOCK_ID).toString();
