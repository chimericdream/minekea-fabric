...
public class JungleBarrel extends GenericBarrel {
    public static final Identifier BLOCK_ID = new Identifier(ModInfo.MOD_ID, "barrels/jungle_barrel");
    ...
    public static final String PLANK_MATERIAL = "minecraft:jungle_planks";
    public static final String SLAB_MATERIAL = "minecraft:jungle_slab";
