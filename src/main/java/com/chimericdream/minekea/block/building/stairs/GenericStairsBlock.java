...
//        Identifier INNER_MODEL_ID = Identifier.of(ModInfo.MOD_ID, MAIN_MODEL_ID.getPath() + "_inner");
//        Identifier OUTER_MODEL_ID = Identifier.of(ModInfo.MOD_ID, MAIN_MODEL_ID.getPath() + "_outer");
...
//        public Identifier getBlockId() {
//            if (blockId == null) {
//                blockId = Identifier.of(ModInfo.MOD_ID, String.format("%sbuilding/stairs/%s", ModInfo.getModPrefix(modId), mainMaterial));
//            }
//
//            return blockId;
//        }
