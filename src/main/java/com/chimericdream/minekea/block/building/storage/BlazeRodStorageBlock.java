...
public class BlazeRodStorageBlock extends GenericStorageBlock {
    public BlazeRodStorageBlock() {
        super(new ModBlock.Config().settings(AbstractBlock.Settings.copy(Blocks.HAY_BLOCK).sounds(BlockSoundGroup.NETHER_STEM)).item(Items.BLAZE_ROD).material("blaze_rod"));
    }
