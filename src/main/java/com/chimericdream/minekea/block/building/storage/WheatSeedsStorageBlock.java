...
public class WheatSeedsStorageBlock extends GenericStorageBlock {
    public WheatSeedsStorageBlock() {
        super(new ModBlock.Config().settings(AbstractBlock.Settings.copy(Blocks.HAY_BLOCK).nonOpaque().sounds(BlockSoundGroup.CROP)).item(Items.WHEAT_SEEDS).material("wheat_seeds"), true);
    }
