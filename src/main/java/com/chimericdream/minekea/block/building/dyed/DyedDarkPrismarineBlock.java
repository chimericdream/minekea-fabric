...
public class DyedDarkPrismarineBlock extends Block implements MinekeaBlock {
    public DyedDarkPrismarineBlock(DyedBlockSettings settings) {
        super(settings);
    }
    ...
    public void setupResources() {
        ...
        MinekeaResourcePack.RESOURCE_PACK.addRecipe(
            ...
            JRecipe.shaped(
                JPattern.pattern("###", "#D#", "###"),
                JKeys.keys()
                    .key("#", JIngredient.ingredient().item("minecraft:dark_prismarine"))
    ...
    public static class DyedDarkPrismarineSettings extends DyedBlockSettings {
        public DyedDarkPrismarineSettings(DefaultSettings settings) {
            super(settings);
        }

        public String getNamePattern() {
            return Objects.requireNonNullElse(namePatternOverride, "%s Dyed Dark Prismarine");
        }

        @Override
        public Identifier getBlockId() {
            if (blockId == null) {
                blockId = new Identifier(ModInfo.MOD_ID, String.format("building/dyed/dark_prismarine/" + color));
            }
