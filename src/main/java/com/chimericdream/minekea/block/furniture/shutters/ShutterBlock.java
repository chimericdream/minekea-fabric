...
public class ShutterBlock extends Block implements MinekeaBlock, Waterloggable {
    ...
    public void setupResources() {
        ...
        Identifier OPEN_MODEL_ID = new Identifier(CLOSED_MODEL_ID + "_open");
    ...
    public static class ShutterSettings extends MinekeaBlockSettings<ShutterSettings> {
        ...
        public Identifier getBlockId() {
            if (blockId == null) {
                blockId = new Identifier(ModInfo.MOD_ID, String.format("%sfurniture/shutters/%s", ModInfo.getModPrefix(modId), mainMaterial));
            }
