...
public class BirchBookshelfTrapdoor extends PublicTrapdoorBlock {
    public static final Identifier BLOCK_ID = new Identifier(ModInfo.MOD_ID, "bookshelves/trapdoors/birch_bookshelf_trapdoor");

    public BirchBookshelfTrapdoor() {
