...
public class MossyBasaltBrickStairsBlock extends StairsBlock implements MinekeaBlock {
    public static final Identifier BLOCK_ID = new Identifier(ModInfo.MOD_ID, "building/mossy_basalt_brick_stairs");

    public MossyBasaltBrickStairsBlock() {
    ...
    public void setupResources() {
        ...
        MinekeaResourcePack.RESOURCE_PACK.addRecipe(
            ...
            JRecipe.shaped(
                JPattern.pattern("#  ", "## ", "###"),
                JKeys.keys()
                    .key("#", JIngredient.ingredient().item(MossyBasaltBricksBlock.BLOCK_ID.toString())),
