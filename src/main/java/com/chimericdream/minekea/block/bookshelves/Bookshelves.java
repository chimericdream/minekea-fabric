...
public class Bookshelves {
    ...
    public void register() {
        ...
        ACACIA_STORAGE_SHELF_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(ModInfo.MOD_ID, "acacia_storage_shelf_block_entity"), FabricBlockEntityTypeBuilder.create(AcaciaStorageBookshelfBlockEntity::new, ACACIA_STORAGE_SHELF).build(null));
        BIRCH_STORAGE_SHELF_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(ModInfo.MOD_ID, "birch_storage_shelf_block_entity"), FabricBlockEntityTypeBuilder.create(BirchStorageBookshelfBlockEntity::new, BIRCH_STORAGE_SHELF).build(null));
        CRIMSON_STORAGE_SHELF_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(ModInfo.MOD_ID, "crimson_storage_shelf_block_entity"), FabricBlockEntityTypeBuilder.create(CrimsonStorageBookshelfBlockEntity::new, CRIMSON_STORAGE_SHELF).build(null));
        DARK_OAK_STORAGE_SHELF_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(ModInfo.MOD_ID, "dark_oak_storage_shelf_block_entity"), FabricBlockEntityTypeBuilder.create(DarkOakStorageBookshelfBlockEntity::new, DARK_OAK_STORAGE_SHELF).build(null));
        JUNGLE_STORAGE_SHELF_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(ModInfo.MOD_ID, "jungle_storage_shelf_block_entity"), FabricBlockEntityTypeBuilder.create(JungleStorageBookshelfBlockEntity::new, JUNGLE_STORAGE_SHELF).build(null));
        OAK_STORAGE_SHELF_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(ModInfo.MOD_ID, "oak_storage_shelf_block_entity"), FabricBlockEntityTypeBuilder.create(OakStorageBookshelfBlockEntity::new, OAK_STORAGE_SHELF).build(null));
        SPRUCE_STORAGE_SHELF_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(ModInfo.MOD_ID, "spruce_storage_shelf_block_entity"), FabricBlockEntityTypeBuilder.create(SpruceStorageBookshelfBlockEntity::new, SPRUCE_STORAGE_SHELF).build(null));
        WARPED_STORAGE_SHELF_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(ModInfo.MOD_ID, "warped_storage_shelf_block_entity"), FabricBlockEntityTypeBuilder.create(WarpedStorageBookshelfBlockEntity::new, WARPED_STORAGE_SHELF).build(null));
    }
