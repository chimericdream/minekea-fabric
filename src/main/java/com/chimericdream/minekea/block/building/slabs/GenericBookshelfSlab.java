...
//
//        Identifier defaultDoubleModelId = Identifier.of(ModInfo.MOD_ID, String.format("block/%sfurniture/bookshelves/%s0", ModInfo.getModPrefix(settings.getModId()), settings.getMainMaterial()));
//
//        Identifier SLAB_MODEL_ID = Model.getBlockModelID(getBlockID());
//        Identifier TOP_SLAB_MODEL_ID = Identifier.of(SLAB_MODEL_ID + "_top");
...
//        public Identifier getBlockId() {
//            if (blockId == null) {
//                blockId = Identifier.of(ModInfo.MOD_ID, String.format("%sbuilding/slabs/bookshelves/%s", ModInfo.getModPrefix(modId), mainMaterial));
//            }
//
//            return blockId;
//        }
