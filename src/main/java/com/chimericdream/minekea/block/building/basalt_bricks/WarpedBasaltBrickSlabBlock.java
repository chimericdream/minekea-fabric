...
public class WarpedBasaltBrickSlabBlock extends SlabBlock implements MinekeaBlock {
    public static final Identifier BLOCK_ID = new Identifier(ModInfo.MOD_ID, "building/warped_basalt_brick_slab");

    public WarpedBasaltBrickSlabBlock() {
    ...
    public void setupResources() {
        ...
        Identifier DOUBLE_MODEL_ID = Model.getItemModelID(WarpedBasaltBricksBlock.BLOCK_ID);
        ...
        MinekeaResourcePack.RESOURCE_PACK.addRecipe(
            ...
            JRecipe.shaped(
                JPattern.pattern("###"),
                JKeys.keys().key("#", JIngredient.ingredient().item(WarpedBasaltBricksBlock.BLOCK_ID.toString())),
        ...
        String warpedBricksTexture = Texture.getBlockTextureID(WarpedBasaltBricksBlock.BLOCK_ID).toString();
