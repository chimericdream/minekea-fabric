...
//import com.chimericdream.minekea.resource.Recipe;
...
//
//        BLOCK_ID = Identifier.of(ModInfo.MOD_ID, String.format("building/compressed/%s/%dx", settings.getMainMaterial(), settings.getCompressionLevel()));
//
//        if (settings.getCompressionLevel() > 1) {
//            PARENT_BLOCK_ID = Identifier.of(ModInfo.MOD_ID, String.format("building/compressed/%s/%dx", settings.getMainMaterial(), settings.getCompressionLevel() - 1));
//        } else {
...
//        return Registries.BLOCK.get(BASE_BLOCK_ID).getTranslationKey();
//    }
//
...
//        Registry.register(Registries.ITEM, BLOCK_ID, new BlockItem(this, new Item.Settings().group(ItemGroups.COMPRESSED_BLOCKS)));
//
//        setupResources();
//    }
//
...
//        public Identifier getBlockId() {
//            if (blockId == null) {
//                blockId = Identifier.of(ModInfo.MOD_ID, String.format("%sbuilding/compressed/%s/%dx", ModInfo.getModPrefix(modId), mainMaterial, compressionLevel));
//            }
//
//            return blockId;
//        }
