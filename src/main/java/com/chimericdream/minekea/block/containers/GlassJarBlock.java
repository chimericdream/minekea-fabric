...
//            Identifier heldItemId = Registries.ITEM.getId(heldItem.getItem());
...
//            if (
//                heldItem.isOf(Items.HONEY_BOTTLE)
...
//            }
//        } else if (
//            heldItem.isOf(Items.GLASS_BOTTLE)
//                && entity.hasFluid()
...
//                Fluid fluid = Registry.FLUID.get(Identifier.of(storedFluid));
//
...
//        }
//
//        if (item.isOf(Items.POTION) && PotionUtil.getPotion(item) == Potions.WATER) {
//            return true;
//        }
//
...
//        ContainerBlocks.GLASS_JAR_ITEM = Registry.register(Registries.ITEM, BLOCK_ID, new BlockItem(this, new Item.Settings().group(ItemGroup.DECORATIONS).maxCount(8)));
//
//        setupResources();
//    }
//
...
//            MinekeaTags.JAR_STORABLE.add(Identifier.of(id));
//        }
//
