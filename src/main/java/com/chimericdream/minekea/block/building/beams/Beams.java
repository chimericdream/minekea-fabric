...
public class Beams implements MinekeaBlockCategory {
    ...
    static {
        BLOCKS = List.of(
            ...
            new GenericBeamBlock(AbstractBlock.Settings.copy(Blocks.SPRUCE_PLANKS), new GenericBeamBlock.BeamConfig(Blocks.SPRUCE_PLANKS, "spruce", "Sspruce", true, false, Registries.BLOCK.getId(Blocks.SPRUCE_PLANKS).withPrefixedPath("block/"))),
