...
public class GenericBookshelfTrapdoor extends TrapdoorBlock implements MinekeaBlock {
    ...
    public void setupResources() {
        ...
        Identifier OPEN_MODEL_ID = new Identifier(BASE_MODEL_ID + "_open");
    ...
    public static class BookshelfTrapdoorSettings extends MinekeaBlockSettings<BookshelfTrapdoorSettings> {
        ...
        public Identifier getBlockId() {
            if (blockId == null) {
                blockId = new Identifier(ModInfo.MOD_ID, String.format("%sfurniture/trapdoors/bookshelves/%s", ModInfo.getModPrefix(modId), mainMaterial));
            }
