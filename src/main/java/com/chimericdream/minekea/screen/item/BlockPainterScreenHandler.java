...
//                case 1 -> item.isOf(Items.ORANGE_DYE);
//                case 2 -> item.isOf(Items.MAGENTA_DYE);
//                case 3 -> item.isOf(Items.LIGHT_BLUE_DYE);
//                case 4 -> item.isOf(Items.YELLOW_DYE);
//                case 5 -> item.isOf(Items.LIME_DYE);
//                case 6 -> item.isOf(Items.PINK_DYE);
//                case 7 -> item.isOf(Items.GRAY_DYE);
//                case 8 -> item.isOf(Items.LIGHT_GRAY_DYE);
//                case 9 -> item.isOf(Items.CYAN_DYE);
//                case 10 -> item.isOf(Items.PURPLE_DYE);
//                case 11 -> item.isOf(Items.BLUE_DYE);
//                case 12 -> item.isOf(Items.BROWN_DYE);
//                case 13 -> item.isOf(Items.GREEN_DYE);
//                case 14 -> item.isOf(Items.RED_DYE);
//                case 15 -> item.isOf(Items.BLACK_DYE);
//                default -> false;
//            };
//        }
//    }
