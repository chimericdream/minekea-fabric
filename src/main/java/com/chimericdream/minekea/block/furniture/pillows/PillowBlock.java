...
//
//        MinekeaResourcePack.RESOURCE_PACK.addRecipe(
//            Identifier.of(ModInfo.MOD_ID, "furniture/pillows/" + ingredient.getPath() + "_reverse"),
//            JRecipe.shapeless(
...
//
//            if (blockId == null) {
//                blockId = Identifier.of(ModInfo.MOD_ID, String.format("furniture/pillows/" + ingredient.getPath()));
//            }
//
//            return blockId;
//        }
