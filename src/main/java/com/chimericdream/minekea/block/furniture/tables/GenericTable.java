...
//
//        Identifier NORTH_CONN = Identifier.of(ModInfo.MOD_ID, "block/furniture/tables/table_north_connected");
//        Identifier SOUTH_CONN = Identifier.of(ModInfo.MOD_ID, "block/furniture/tables/table_south_connected");
//        Identifier EAST_CONN = Identifier.of(ModInfo.MOD_ID, "block/furniture/tables/table_east_connected");
//        Identifier WEST_CONN = Identifier.of(ModInfo.MOD_ID, "block/furniture/tables/table_west_connected");
//
//        Identifier NORTH_EAST_CONN = Identifier.of(ModInfo.MOD_ID, "block/furniture/tables/table_north_east_connected");
//        Identifier SOUTH_EAST_CONN = Identifier.of(ModInfo.MOD_ID, "block/furniture/tables/table_south_east_connected");
//
//        Identifier NORTH_WEST_CONN = Identifier.of(ModInfo.MOD_ID, "block/furniture/tables/table_north_west_connected");
//        Identifier SOUTH_WEST_CONN = Identifier.of(ModInfo.MOD_ID, "block/furniture/tables/table_south_west_connected");
//
//        Identifier ALL_CONN = Identifier.of(ModInfo.MOD_ID, "block/furniture/tables/table_all_connected");
//
//        Map<String, Identifier> OTHER_MODEL_IDS = Map.of(
//            "north", Identifier.of(MODEL_ID + "_north"),
//            "east", Identifier.of(MODEL_ID + "_east"),
//            "south", Identifier.of(MODEL_ID + "_south"),
//            "west", Identifier.of(MODEL_ID + "_west"),
//            "north_east", Identifier.of(MODEL_ID + "_north_east"),
//            "south_east", Identifier.of(MODEL_ID + "_south_east"),
//            "north_west", Identifier.of(MODEL_ID + "_north_west"),
//            "south_west", Identifier.of(MODEL_ID + "_south_west"),
//            "all", Identifier.of(MODEL_ID + "_all")
//        );
//
...
//        public Identifier getBlockId() {
//            if (blockId == null) {
//                blockId = Identifier.of(ModInfo.MOD_ID, String.format("%sfurniture/tables/%s", ModInfo.getModPrefix(modId), mainMaterial));
//            }
//
//            return blockId;
//        }
