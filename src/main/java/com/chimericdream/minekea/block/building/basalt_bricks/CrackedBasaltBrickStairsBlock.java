...
public class CrackedBasaltBrickStairsBlock extends StairsBlock implements MinekeaBlock {
    public static final Identifier BLOCK_ID = new Identifier(ModInfo.MOD_ID, "building/cracked_basalt_brick_stairs");

    public CrackedBasaltBrickStairsBlock() {
    ...
    public void setupResources() {
        ...
        MinekeaResourcePack.RESOURCE_PACK.addRecipe(
            ...
            JRecipe.shaped(
                JPattern.pattern("#  ", "## ", "###"),
                JKeys.keys()
                    .key("#", JIngredient.ingredient().item(CrackedBasaltBricksBlock.BLOCK_ID.toString())),
