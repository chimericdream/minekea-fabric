...
public class BygTrapdoors {
    ...
    public static final GenericBookshelfTrapdoor BAOBAB_BOOKSHELF_TRAPDOOR;
    public static final GenericBookshelfTrapdoor BLUE_ENCHANTED_BOOKSHELF_TRAPDOOR;
    public static final GenericBookshelfTrapdoor BULBIS_BOOKSHELF_TRAPDOOR;
    public static final GenericBookshelfTrapdoor CHERRY_BOOKSHELF_TRAPDOOR;
    public static final GenericBookshelfTrapdoor CIKA_BOOKSHELF_TRAPDOOR;
    public static final GenericBookshelfTrapdoor CYPRESS_BOOKSHELF_TRAPDOOR;
    public static final GenericBookshelfTrapdoor EBONY_BOOKSHELF_TRAPDOOR;
    public static final GenericBookshelfTrapdoor EMBUR_BOOKSHELF_TRAPDOOR;
    public static final GenericBookshelfTrapdoor ETHER_BOOKSHELF_TRAPDOOR;
    ...
    public static final GenericBookshelfTrapdoor PINE_BOOKSHELF_TRAPDOOR;
    public static final GenericBookshelfTrapdoor RAINBOW_EUCALYPTUS_BOOKSHELF_TRAPDOOR;
    ...
    public void register() {
        ASPEN_BOOKSHELF_TRAPDOOR.register();
        BAOBAB_BOOKSHELF_TRAPDOOR.register();
        BLUE_ENCHANTED_BOOKSHELF_TRAPDOOR.register();
        BULBIS_BOOKSHELF_TRAPDOOR.register();
        CHERRY_BOOKSHELF_TRAPDOOR.register();
        CIKA_BOOKSHELF_TRAPDOOR.register();
        CYPRESS_BOOKSHELF_TRAPDOOR.register();
        EBONY_BOOKSHELF_TRAPDOOR.register();
        EMBUR_BOOKSHELF_TRAPDOOR.register();
        ETHER_BOOKSHELF_TRAPDOOR.register();
        ...
        PINE_BOOKSHELF_TRAPDOOR.register();
        RAINBOW_EUCALYPTUS_BOOKSHELF_TRAPDOOR.register();
