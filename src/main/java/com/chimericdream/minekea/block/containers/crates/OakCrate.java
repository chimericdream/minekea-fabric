...
public class OakCrate extends GenericCrate {
    public OakCrate() {
        ...
        this.BLOCK_ID = Identifier.of(ModInfo.MOD_ID, "containers/crates/oak");
    }
    ...
    public void configureRecipes(RecipeExporter exporter) {
        this.registerRecipe(exporter, Items.OAK_PLANKS, MinecraftItemTags.OAK_LOGS);
    }

    @Override
    public void configureTranslations(RegistryWrapper.WrapperLookup registryLookup, FabricLanguageProvider.TranslationBuilder translationBuilder) {
        translationBuilder.add(this, "Oak Crate");
    }

    @Override
    public void configureBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        TextureMap textures = new TextureMap()
            .put(MinekeaTextures.BRACE, Registries.BLOCK.getId(Blocks.STRIPPED_OAK_LOG).withPrefixedPath("block/"))
            .put(MinekeaTextures.MATERIAL, Registries.BLOCK.getId(Blocks.OAK_PLANKS).withPrefixedPath("block/"));
