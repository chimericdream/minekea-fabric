...
public class PumpkinSeedsStorageBlock extends GenericStorageBlock {
    public PumpkinSeedsStorageBlock() {
        super(new BlockConfig().settings(AbstractBlock.Settings.copy(Blocks.HAY_BLOCK).nonOpaque().sounds(BlockSoundGroup.CROP)).item(Items.PUMPKIN_SEEDS).material("pumpkin_seeds"), true);
    }
