...
public class CrimsonBarrel extends GenericBarrel {
    ...
    public static final Identifier MODEL_ID = new Identifier(ModInfo.MOD_ID, "block/barrels/crimson_barrel");
    public static final Identifier OPEN_MODEL_ID = new Identifier(ModInfo.MOD_ID, "block/barrels/crimson_barrel_open");
    public static final String PLANK_MATERIAL = "minecraft:crimson_planks";
    public static final String SLAB_MATERIAL = "minecraft:crimson_slab";
