...
import com.chimericdream.lib.fabric.blocks.FabricModSlabBlock;
...
public class GenericSlabBlock extends FabricModSlabBlock {
    public final Identifier BLOCK_ID;

    public GenericSlabBlock(ModBlock.Config config) {
        super(config);
