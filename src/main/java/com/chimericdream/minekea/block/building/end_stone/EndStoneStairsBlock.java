...
public class EndStoneStairsBlock extends StairsBlock implements MinekeaBlock {
    public static final Identifier BLOCK_ID = new Identifier(ModInfo.MOD_ID, "building/end_stone_stairs");
    ...
    public void setupResources() {
        ...
        MinekeaResourcePack.RESOURCE_PACK.addRecipe(
            ...
            JRecipe.shaped(
                JPattern.pattern("#  ", "## ", "###"),
                JKeys.keys()
                    .key("#", JIngredient.ingredient().item("minecraft:end_stone")),
        ...
        String texture = Texture.getBlockTextureID(Registry.BLOCK.getId(Blocks.END_STONE)).toString();
