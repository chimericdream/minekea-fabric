...
public class EndStoneSlabBlock extends SlabBlock implements MinekeaBlock {
    public static final Identifier BLOCK_ID = new Identifier(ModInfo.MOD_ID, "building/end_stone_slab");
    ...
    public void setupResources() {
        ...
        Identifier DOUBLE_MODEL_ID = Model.getItemModelID(Registry.BLOCK.getId(Blocks.END_STONE));
        ...
        MinekeaResourcePack.RESOURCE_PACK.addRecipe(
            ...
            JRecipe.shaped(
                JPattern.pattern("###"),
                JKeys.keys().key("#", JIngredient.ingredient().item("minecraft:end_stone")),
        ...
        String warpedBricksTexture = Texture.getBlockTextureID(Registry.BLOCK.getId(Blocks.END_STONE)).toString();
