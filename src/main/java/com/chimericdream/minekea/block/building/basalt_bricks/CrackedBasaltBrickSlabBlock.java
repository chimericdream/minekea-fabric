...
public class CrackedBasaltBrickSlabBlock extends SlabBlock implements MinekeaBlock {
    public static final Identifier BLOCK_ID = new Identifier(ModInfo.MOD_ID, "building/cracked_basalt_brick_slab");

    public CrackedBasaltBrickSlabBlock() {
    ...
    public void setupResources() {
        ...
        Identifier DOUBLE_MODEL_ID = Model.getItemModelID(CrackedBasaltBricksBlock.BLOCK_ID);
        ...
        MinekeaResourcePack.RESOURCE_PACK.addRecipe(
            ...
            JRecipe.shaped(
                JPattern.pattern("###"),
                JKeys.keys().key("#", JIngredient.ingredient().item(CrackedBasaltBricksBlock.BLOCK_ID.toString())),
        ...
        String warpedBricksTexture = Texture.getBlockTextureID(CrackedBasaltBricksBlock.BLOCK_ID).toString();
