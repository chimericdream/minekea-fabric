...
import net.fabricmc.chimericdream.screen.crate.DarkOakCrateScreenHandler;
...
public class DarkOakCrateBlockEntity extends BlockEntity implements NamedScreenHandlerFactory, ImplementedInventory {
    ...
    public ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
        ...
        return new DarkOakCrateScreenHandler(syncId, playerInventory, this);
    }
