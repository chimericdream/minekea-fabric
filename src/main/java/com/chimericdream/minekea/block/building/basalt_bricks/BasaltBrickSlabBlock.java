...
public class BasaltBrickSlabBlock extends SlabBlock implements MinekeaBlock {
    public static final Identifier BLOCK_ID = new Identifier(ModInfo.MOD_ID, "building/basalt_brick_slab");
    ...
    public void setupResources() {
        ...
        Identifier DOUBLE_MODEL_ID = Model.getItemModelID(BasaltBricksBlock.BLOCK_ID);
        ...
        String warpedBricksTexture = Texture.getBlockTextureID(BasaltBricksBlock.BLOCK_ID).toString();
