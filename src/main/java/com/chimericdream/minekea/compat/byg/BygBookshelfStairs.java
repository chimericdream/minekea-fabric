...
public class BygBookshelfStairs {
    ...
    static {
        ...
        ASPEN_VERTICAL_BOOKSHELF_STAIRS = new GenericVerticalBookshelfStairs(new VerticalBookshelfStairsSettings(BygBlockSettings.ASPEN).addMaterial("bookshelf", new Identifier("byg:aspen_bookshelf")).addMaterial("model", new Identifier("byg:block/aspen_bookshelf")));
        BAOBAB_VERTICAL_BOOKSHELF_STAIRS = new GenericVerticalBookshelfStairs(new VerticalBookshelfStairsSettings(BygBlockSettings.BAOBAB).addMaterial("bookshelf", new Identifier("byg:baobab_bookshelf")).addMaterial("model", new Identifier("byg:block/baobab_bookshelf")));
        BLUE_ENCHANTED_VERTICAL_BOOKSHELF_STAIRS = new GenericVerticalBookshelfStairs(new VerticalBookshelfStairsSettings(BygBlockSettings.BLUE_ENCHANTED).addMaterial("bookshelf", new Identifier("byg:blue_enchanted_bookshelf")).addMaterial("model", new Identifier("byg:block/blue_enchanted_bookshelf")));
        BULBIS_VERTICAL_BOOKSHELF_STAIRS = new GenericVerticalBookshelfStairs(new VerticalBookshelfStairsSettings(BygBlockSettings.BULBIS).addMaterial("bookshelf", new Identifier("byg:bulbis_bookshelf")).addMaterial("model", new Identifier("byg:block/bulbis_bookshelf")));
        CHERRY_VERTICAL_BOOKSHELF_STAIRS = new GenericVerticalBookshelfStairs(new VerticalBookshelfStairsSettings(BygBlockSettings.CHERRY).addMaterial("bookshelf", new Identifier("byg:cherry_bookshelf")).addMaterial("model", new Identifier("byg:block/cherry_bookshelf")));
        CIKA_VERTICAL_BOOKSHELF_STAIRS = new GenericVerticalBookshelfStairs(new VerticalBookshelfStairsSettings(BygBlockSettings.CIKA).addMaterial("bookshelf", new Identifier("byg:cika_bookshelf")).addMaterial("model", new Identifier("byg:block/cika_bookshelf")));
        CYPRESS_VERTICAL_BOOKSHELF_STAIRS = new GenericVerticalBookshelfStairs(new VerticalBookshelfStairsSettings(BygBlockSettings.CYPRESS).addMaterial("bookshelf", new Identifier("byg:cypress_bookshelf")).addMaterial("model", new Identifier("byg:block/cypress_bookshelf")));
        EBONY_VERTICAL_BOOKSHELF_STAIRS = new GenericVerticalBookshelfStairs(new VerticalBookshelfStairsSettings(BygBlockSettings.EBONY).addMaterial("bookshelf", new Identifier("byg:ebony_bookshelf")).addMaterial("model", new Identifier("byg:block/ebony_bookshelf")));
        EMBUR_VERTICAL_BOOKSHELF_STAIRS = new GenericVerticalBookshelfStairs(new VerticalBookshelfStairsSettings(BygBlockSettings.EMBUR).addMaterial("bookshelf", new Identifier("byg:embur_bookshelf")).addMaterial("model", new Identifier("byg:block/embur_bookshelf")));
        ETHER_VERTICAL_BOOKSHELF_STAIRS = new GenericVerticalBookshelfStairs(new VerticalBookshelfStairsSettings(BygBlockSettings.ETHER).addMaterial("bookshelf", new Identifier("byg:ether_bookshelf")).addMaterial("model", new Identifier("byg:block/ether_bookshelf")));
        FIR_VERTICAL_BOOKSHELF_STAIRS = new GenericVerticalBookshelfStairs(new VerticalBookshelfStairsSettings(BygBlockSettings.FIR).addMaterial("bookshelf", new Identifier("byg:fir_bookshelf")).addMaterial("model", new Identifier("byg:block/fir_bookshelf")));
        GREEN_ENCHANTED_VERTICAL_BOOKSHELF_STAIRS = new GenericVerticalBookshelfStairs(new VerticalBookshelfStairsSettings(BygBlockSettings.GREEN_ENCHANTED).addMaterial("bookshelf", new Identifier("byg:green_enchanted_bookshelf")).addMaterial("model", new Identifier("byg:block/green_enchanted_bookshelf")));
        HOLLY_VERTICAL_BOOKSHELF_STAIRS = new GenericVerticalBookshelfStairs(new VerticalBookshelfStairsSettings(BygBlockSettings.HOLLY).addMaterial("bookshelf", new Identifier("byg:holly_bookshelf")).addMaterial("model", new Identifier("byg:block/holly_bookshelf")));
        IMPARIUS_VERTICAL_BOOKSHELF_STAIRS = new GenericVerticalBookshelfStairs(new VerticalBookshelfStairsSettings(BygBlockSettings.IMPARIUS).addMaterial("bookshelf", new Identifier("byg:imparius_bookshelf")).addMaterial("model", new Identifier("byg:block/imparius_bookshelf")));
        ...
        PINE_VERTICAL_BOOKSHELF_STAIRS = new GenericVerticalBookshelfStairs(new VerticalBookshelfStairsSettings(BygBlockSettings.PINE).addMaterial("bookshelf", new Identifier("byg:pine_bookshelf")).addMaterial("model", new Identifier("byg:block/pine_bookshelf")));
        RAINBOW_EUCALYPTUS_VERTICAL_BOOKSHELF_STAIRS = new GenericVerticalBookshelfStairs(new VerticalBookshelfStairsSettings(BygBlockSettings.RAINBOW_EUCALYPTUS).addMaterial("bookshelf", new Identifier("byg:rainbow_eucalyptus_bookshelf")).addMaterial("model", new Identifier("byg:block/rainbow_eucalyptus_bookshelf")));
        REDWOOD_VERTICAL_BOOKSHELF_STAIRS = new GenericVerticalBookshelfStairs(new VerticalBookshelfStairsSettings(BygBlockSettings.REDWOOD).addMaterial("bookshelf", new Identifier("byg:redwood_bookshelf")).addMaterial("model", new Identifier("byg:block/redwood_bookshelf")));
        SKYRIS_VERTICAL_BOOKSHELF_STAIRS = new GenericVerticalBookshelfStairs(new VerticalBookshelfStairsSettings(BygBlockSettings.SKYRIS).addMaterial("bookshelf", new Identifier("byg:skyris_bookshelf")).addMaterial("model", new Identifier("byg:block/skyris_bookshelf")));
        SYTHIAN_VERTICAL_BOOKSHELF_STAIRS = new GenericVerticalBookshelfStairs(new VerticalBookshelfStairsSettings(BygBlockSettings.SYTHIAN).addMaterial("bookshelf", new Identifier("byg:sythian_bookshelf")).addMaterial("model", new Identifier("byg:block/sythian_bookshelf")));
        WILLOW_VERTICAL_BOOKSHELF_STAIRS = new GenericVerticalBookshelfStairs(new VerticalBookshelfStairsSettings(BygBlockSettings.WILLOW).addMaterial("bookshelf", new Identifier("byg:willow_bookshelf")).addMaterial("model", new Identifier("byg:block/willow_bookshelf")));
        WITCH_HAZEL_VERTICAL_BOOKSHELF_STAIRS = new GenericVerticalBookshelfStairs(new VerticalBookshelfStairsSettings(BygBlockSettings.WITCH_HAZEL).addMaterial("bookshelf", new Identifier("byg:witch_hazel_bookshelf")).addMaterial("model", new Identifier("byg:block/witch_hazel_bookshelf")));
        ZELKOVA_VERTICAL_BOOKSHELF_STAIRS = new GenericVerticalBookshelfStairs(new VerticalBookshelfStairsSettings(BygBlockSettings.ZELKOVA).addMaterial("bookshelf", new Identifier("byg:zelkova_bookshelf")).addMaterial("model", new Identifier("byg:block/zelkova_bookshelf")));
    }
