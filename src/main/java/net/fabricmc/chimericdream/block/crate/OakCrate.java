...
import net.fabricmc.chimericdream.block.crate.entity.OakCrateBlockEntity;
...
public class OakCrate extends AbstractCrate {
    public static final Identifier BLOCK_ID = new Identifier(ModInfo.MOD_ID, "oak_crate");
