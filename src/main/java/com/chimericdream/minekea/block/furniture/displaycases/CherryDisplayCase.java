...
public class CherryDisplayCase extends GenericDisplayCase {
    public static final Identifier BLOCK_ID = Identifier.of(ModInfo.MOD_ID, "furniture/display_cases/cherry");

    public CherryDisplayCase() {
        super(AbstractBlock.Settings.copy(Blocks.CHERRY_PLANKS));
    }
