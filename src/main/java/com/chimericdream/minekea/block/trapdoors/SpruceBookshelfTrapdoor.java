...
public class SpruceBookshelfTrapdoor extends PublicTrapdoorBlock {
    public static final Identifier BLOCK_ID = new Identifier(ModInfo.MOD_ID, "bookshelves/trapdoors/spruce_bookshelf_trapdoor");

    public SpruceBookshelfTrapdoor() {
