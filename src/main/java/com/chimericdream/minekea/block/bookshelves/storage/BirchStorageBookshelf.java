...
import com.chimericdream.minekea.block.bookshelves.storage.entity.BirchStorageBookshelfBlockEntity;
...
public class BirchStorageBookshelf extends GenericStorageBookshelf implements BlockEntityProvider {
    public static final Identifier BLOCK_ID = new Identifier(ModInfo.MOD_ID, "bookshelves/storage/birch_storage_shelf");
