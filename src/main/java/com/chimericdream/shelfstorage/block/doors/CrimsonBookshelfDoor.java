package com.chimericdream.shelfstorage.block.doors;
...
public class CrimsonBookshelfDoor extends PublicDoorBlock {
    public static final Identifier BLOCK_ID = new Identifier(ModInfo.MOD_ID, "crimson_bookshelf_door");

    public CrimsonBookshelfDoor() {
