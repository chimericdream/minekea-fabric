...
public class WarpedNetherBrickSlabBlock extends SlabBlock implements MinekeaBlock {
    public static final Identifier BLOCK_ID = new Identifier(ModInfo.MOD_ID, "building/warped_nether_brick_slab");

    public WarpedNetherBrickSlabBlock() {
        super(FabricBlockSettings.copyOf(Blocks.RED_NETHER_BRICK_SLAB));
    }
    ...
    public void setupResources() {
        ...
        Identifier DOUBLE_MODEL_ID = Model.getItemModelID(WarpedNetherBricksBlock.BLOCK_ID);
        ...
        MinekeaResourcePack.RESOURCE_PACK.addRecipe(
            ...
            JRecipe.shaped(
                JPattern.pattern("###"),
                JKeys.keys().key("#", JIngredient.ingredient().item(WarpedNetherBricksBlock.BLOCK_ID.toString())),
        ...
        String warpedBricksTexture = Texture.getBlockTextureID(WarpedNetherBricksBlock.BLOCK_ID).toString();
