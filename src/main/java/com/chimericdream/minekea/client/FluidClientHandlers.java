...
//import static com.chimericdream.minekea.fluid.Fluids.FLOWING_HONEY_ID;
//import static com.chimericdream.minekea.fluid.Fluids.FLOWING_MILK;
//import static com.chimericdream.minekea.fluid.Fluids.FLOWING_MILK_ID;
//import static com.chimericdream.minekea.fluid.Fluids.HONEY;
//import static com.chimericdream.minekea.fluid.Fluids.HONEY_ID;
//import static com.chimericdream.minekea.fluid.Fluids.MILK;
//import static com.chimericdream.minekea.fluid.Fluids.MILK_ID;
//
...
//        });
//
//        Identifier listenerId = Identifier.of(MILK_ID.getNamespace(), MILK_ID.getPath() + "_reload_listener");
//
...
//        });
//
//        Identifier listenerId = Identifier.of(HONEY_ID.getNamespace(), HONEY_ID.getPath() + "_reload_listener");
//
//        Sprite[] sprites = {null, null};
//
//        ResourceManagerHelper.get(ResourceType.CLIENT_RESOURCES).registerReloadListener(new SimpleSynchronousResourceReloadListener() {
