...
public class AcaciaBookshelfDoor extends PublicDoorBlock {
    public static final Identifier BLOCK_ID = new Identifier(ModInfo.MOD_ID, "acacia_bookshelf_door");

    public AcaciaBookshelfDoor() {
