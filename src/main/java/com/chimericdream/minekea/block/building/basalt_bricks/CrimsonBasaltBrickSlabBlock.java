...
public class CrimsonBasaltBrickSlabBlock extends SlabBlock implements MinekeaBlock {
    public static final Identifier BLOCK_ID = new Identifier(ModInfo.MOD_ID, "building/crimson_basalt_brick_slab");

    public CrimsonBasaltBrickSlabBlock() {
    ...
    public void setupResources() {
        ...
        Identifier DOUBLE_MODEL_ID = Model.getItemModelID(CrimsonBasaltBricksBlock.BLOCK_ID);
        ...
        MinekeaResourcePack.RESOURCE_PACK.addRecipe(
            ...
            JRecipe.shaped(
                JPattern.pattern("###"),
                JKeys.keys().key("#", JIngredient.ingredient().item(CrimsonBasaltBricksBlock.BLOCK_ID.toString())),
