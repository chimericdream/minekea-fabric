...
public class AcaciaStorageBookshelfBlockEntity extends GenericStorageBookshelfBlockEntity {
    public AcaciaStorageBookshelfBlockEntity(BlockPos pos, BlockState state) {
        super(Bookshelves.ACACIA_STORAGE_SHELF_BLOCK_ENTITY, pos, state);
    }

    @Override
    public ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
        return new StorageBookshelfScreenHandler(Bookshelves.ACACIA_STORAGE_SHELF_SCREEN_HANDLER, syncId, playerInventory, this);
    }
}
