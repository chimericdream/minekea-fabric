...
//
//    static {
//        DARK_PRISMARINE.add(Identifier.of("minecraft:dark_prismarine"));
//    }
//
...
//        RESOURCE_PACK.addTag(Identifier.of(ModInfo.MOD_ID, "blocks/mineable/axe"), MINEABLE_AXE);
//        RESOURCE_PACK.addTag(Identifier.of(ModInfo.MOD_ID, "blocks/mineable/hoe"), MINEABLE_HOE);
//        RESOURCE_PACK.addTag(Identifier.of(ModInfo.MOD_ID, "blocks/mineable/pickaxe"), MINEABLE_PICKAXE);
//        RESOURCE_PACK.addTag(Identifier.of(ModInfo.MOD_ID, "blocks/mineable/shears"), MINEABLE_SHEARS);
//        RESOURCE_PACK.addTag(Identifier.of(ModInfo.MOD_ID, "blocks/mineable/shovel"), MINEABLE_SHOVEL);
//
//        RESOURCE_PACK.addTag(Identifier.of(ModInfo.MOD_ID, "items/glass_jar_storable"), JAR_STORABLE);
//
//        RESOURCE_PACK.addTag(Identifier.of(ModInfo.MOD_ID, "blocks/dark_prismarine"), DARK_PRISMARINE);
//        RESOURCE_PACK.addTag(Identifier.of(ModInfo.MOD_ID, "blocks/lanterns"), LANTERNS);
//
//        BARRELS.register();
//        BEAMS.register();
...
//            RESOURCE_PACK.addTag(Identifier.of(ModInfo.MOD_ID, String.format("blocks/%s", baseName)), BASE);
//            RESOURCE_PACK.addTag(Identifier.of(ModInfo.MOD_ID, String.format("blocks/non_wooden_%s", baseName)), NON_WOODEN);
//            RESOURCE_PACK.addTag(Identifier.of(ModInfo.MOD_ID, String.format("blocks/wooden_%s", baseName)), WOODEN);
//        }
//    }
//}
