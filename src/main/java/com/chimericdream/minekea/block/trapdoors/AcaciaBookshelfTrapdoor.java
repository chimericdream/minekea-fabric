...
public class AcaciaBookshelfTrapdoor extends PublicTrapdoorBlock {
    public static final Identifier BLOCK_ID = new Identifier(ModInfo.MOD_ID, "bookshelves/trapdoors/acacia_bookshelf_trapdoor");

    public AcaciaBookshelfTrapdoor() {
