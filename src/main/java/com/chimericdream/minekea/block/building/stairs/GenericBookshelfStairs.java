...
//        Identifier INNER_MODEL_ID = Identifier.of(MAIN_MODEL_ID + "_inner");
//        Identifier OUTER_MODEL_ID = Identifier.of(MAIN_MODEL_ID + "_outer");
//
...
//        public Identifier getBlockId() {
//            if (blockId == null) {
//                blockId = Identifier.of(ModInfo.MOD_ID, String.format("%sbuilding/stairs/bookshelves/%s", ModInfo.getModPrefix(modId), mainMaterial));
//            }
//
//            return blockId;
//        }
