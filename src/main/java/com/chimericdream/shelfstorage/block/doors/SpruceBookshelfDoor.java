...
public class SpruceBookshelfDoor extends PublicDoorBlock {
    public static final Identifier BLOCK_ID = new Identifier(ModInfo.MOD_ID, "spruce_bookshelf_door");

    public SpruceBookshelfDoor() {
