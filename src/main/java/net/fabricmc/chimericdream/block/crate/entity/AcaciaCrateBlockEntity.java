...
import net.fabricmc.chimericdream.screen.crate.AcaciaCrateScreenHandler;
...
public class AcaciaCrateBlockEntity extends BlockEntity implements NamedScreenHandlerFactory, ImplementedInventory {
    ...
    public ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
        ...
        return new AcaciaCrateScreenHandler(syncId, playerInventory, this);
    }
