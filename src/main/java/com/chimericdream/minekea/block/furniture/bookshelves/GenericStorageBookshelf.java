...
//
//        Identifier EMPTY_SHELF_MODEL_ID = Identifier.of(BASE_MODEL_ID + "_empty");
//        Identifier ONE_HALF_SHELF_MODEL_ID = Identifier.of(BASE_MODEL_ID + "_one_half");
//        Identifier ONE_QUARTER_SHELF_MODEL_ID = Identifier.of(BASE_MODEL_ID + "_one_quarter");
//        Identifier THREE_QUARTERS_SHELF_MODEL_ID = Identifier.of(BASE_MODEL_ID + "_three_quarters");
...
//            return Identifier.of(ModInfo.MOD_ID, String.format("%sfurniture/bookshelves/%s", ModInfo.getModPrefix(modId), mainMaterial));
//        }
//
//        @Override
//        public Identifier getBlockId() {
//            if (blockId == null) {
//                blockId = Identifier.of(ModInfo.MOD_ID, String.format("%sfurniture/bookshelves/storage/%s", ModInfo.getModPrefix(modId), mainMaterial));
//            }
//
//            return blockId;
//        }
