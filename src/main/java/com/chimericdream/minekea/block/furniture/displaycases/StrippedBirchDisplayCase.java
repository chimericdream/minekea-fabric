...
public class StrippedBirchDisplayCase extends GenericDisplayCase {
    public static final Identifier BLOCK_ID = Identifier.of(ModInfo.MOD_ID, "furniture/display_cases/stripped/birch");

    public StrippedBirchDisplayCase() {
        super(AbstractBlock.Settings.copy(Blocks.BIRCH_PLANKS));
    }
