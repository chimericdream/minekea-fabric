...
public class Stairs implements MinekeaBlockCategory {
    ...
    static {
        ...
        VERTICAL_STAIRS.add(new GenericVerticalStairsBlock("Acacia", "acacia_planks", true, Blocks.ACACIA_PLANKS, Tool.AXE));
        VERTICAL_STAIRS.add(new GenericVerticalStairsBlock("Birch", "birch_planks", true, Blocks.BIRCH_PLANKS, Tool.AXE));
        VERTICAL_STAIRS.add(new GenericVerticalStairsBlock("Cherry", "cherry_planks", true, Blocks.CHERRY_PLANKS, Tool.AXE));
        VERTICAL_STAIRS.add(new GenericVerticalStairsBlock("Crimson", "crimson_planks", false, Blocks.CRIMSON_PLANKS, Tool.AXE));
        VERTICAL_STAIRS.add(new GenericVerticalStairsBlock("Dark Oak", "dark_oak_planks", true, Blocks.DARK_OAK_PLANKS, Tool.AXE));
        VERTICAL_STAIRS.add(new GenericVerticalStairsBlock("Jungle", "jungle_planks", true, Blocks.JUNGLE_PLANKS, Tool.AXE));
        VERTICAL_STAIRS.add(new GenericVerticalStairsBlock("Mangrove", "mangrove_planks", true, Blocks.MANGROVE_PLANKS, Tool.AXE));
        VERTICAL_STAIRS.add(new GenericVerticalStairsBlock("Oak", "oak_planks", true, Blocks.OAK_PLANKS, Tool.AXE));
        VERTICAL_STAIRS.add(new GenericVerticalStairsBlock("Spruce", "spruce_planks", true, Blocks.SPRUCE_PLANKS, Tool.AXE));
        VERTICAL_STAIRS.add(new GenericVerticalStairsBlock("Warped", "warped_planks", false, Blocks.WARPED_PLANKS, Tool.AXE));
        VERTICAL_STAIRS.add(new GenericVerticalStairsBlock("Andesite", "andesite", false, Blocks.ANDESITE));
        VERTICAL_STAIRS.add(new GenericVerticalStairsBlock("Bamboo Mosaic", "bamboo_mosaic", false, Blocks.BAMBOO_MOSAIC, Tool.AXE));
