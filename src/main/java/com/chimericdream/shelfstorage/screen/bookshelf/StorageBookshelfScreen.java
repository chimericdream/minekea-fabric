...
public class StorageBookshelfScreen extends HandledScreen<StorageBookshelfScreenHandler> {
    ...
    protected void drawBackground(MatrixStack matrices, float delta, int mouseX, int mouseY) {
        ...
        this.drawTexture(matrices, i, j, 0, 0, this.backgroundWidth, 35);
        this.drawTexture(matrices, i, j + 35, 0, 126, this.backgroundWidth, 96);
    }
}
