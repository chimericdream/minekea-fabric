...
import net.fabricmc.chimericdream.screen.crate.JungleCrateScreenHandler;
...
public class JungleCrateBlockEntity extends BlockEntity implements NamedScreenHandlerFactory, ImplementedInventory {
    ...
    public ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
        ...
        return new JungleCrateScreenHandler(syncId, playerInventory, this);
    }
