...
public class WarpedBookshelfTrapdoor extends PublicTrapdoorBlock {
    public static final Identifier BLOCK_ID = new Identifier(ModInfo.MOD_ID, "bookshelves/trapdoors/warped_bookshelf_trapdoor");

    public WarpedBookshelfTrapdoor() {
