...
//
//        Identifier INVENTORY_MODEL_ID = Identifier.of(BASE_MODEL_ID + "_inventory");
//        Identifier PRESSED_MODEL_ID = Identifier.of(BASE_MODEL_ID + "_pressed");
//
...
//        public Identifier getBlockId() {
//            if (blockId == null) {
//                blockId = Identifier.of(ModInfo.MOD_ID, String.format("%sredstone/buttons/%s", ModInfo.getModPrefix(modId), mainMaterial));
//            }
//
//            return blockId;
//        }
