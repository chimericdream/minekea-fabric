...
//        return Identifier.of(ModInfo.MOD_ID, String.format("tools/hammers/%s", settings.materialName.toLowerCase()));
//    }
//
//    @Override
...
//        Registry.register(Registries.ITEM, getItemID(), this);
//        setupResources();
//    }
//
//    @Override
...
//    }
//
//    public static class HammerSettings extends AbstractBlock.Settings {
