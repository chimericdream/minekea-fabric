...
public class OakBookshelfDoor extends PublicDoorBlock {
    public static final Identifier BLOCK_ID = new Identifier(ModInfo.MOD_ID, "oak_bookshelf_door");

    public OakBookshelfDoor() {
