...
import net.fabricmc.chimericdream.screen.crate.WarpedCrateScreenHandler;
...
public class WarpedCrateBlockEntity extends BlockEntity implements NamedScreenHandlerFactory, ImplementedInventory {
    ...
    public ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
        ...
        return new WarpedCrateScreenHandler(syncId, playerInventory, this);
    }
