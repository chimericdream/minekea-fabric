...
import com.chimericdream.shelfstorage.screen.JungleStorageShelfScreenHandler;
...
public class JungleStorageShelfBlockEntity extends BlockEntity implements NamedScreenHandlerFactory, ImplementedInventory {
    private final DefaultedList<ItemStack> items = DefaultedList.ofSize(9, ItemStack.EMPTY);

    public JungleStorageShelfBlockEntity(BlockPos pos, BlockState state) {
    ...
    public ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
        ...
        return new JungleStorageShelfScreenHandler(syncId, playerInventory, this);
    }

    public static void tick(World world, BlockPos pos, BlockState state, JungleStorageShelfBlockEntity entity) {
        if (world.isClient()) {
            return;
        }
