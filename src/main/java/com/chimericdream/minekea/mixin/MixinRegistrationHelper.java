...
public class MixinRegistrationHelper implements IMixinConfigPlugin {
    ...
    public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        if (mixinClassName.equals("com.chimericdream.minekea.mixin.EnchantingTableBlockMixin")) {
            ...
            if (isBCLibLoaded) {
                LOGGER.info("[minekea_mixins] BCLib is loaded. Disabling EnchantingTableBlockMixin");
                return false;
            }

            LOGGER.info("[minekea_mixins] BCLib is not loaded. Enabling EnchantingTableBlockMixin");
            return true;
        }
