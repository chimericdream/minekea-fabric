...
import net.fabricmc.chimericdream.screen.crate.SpruceCrateScreenHandler;
...
public class SpruceCrateBlockEntity extends BlockEntity implements NamedScreenHandlerFactory, ImplementedInventory {
    ...
    public ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
        ...
        return new SpruceCrateScreenHandler(syncId, playerInventory, this);
    }
