...
import com.chimericdream.minekea.block.displaycases.entity.OakDisplayCaseBlockEntity;
...
public class OakDisplayCase extends GenericDisplayCase {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new OakDisplayCaseBlockEntity(pos, state);
    }
    ...
    public void register() {
        ...
        setupResources(BLOCK_ID, new String[]{"minecraft:oak_planks", "minecraft:oak_log"});
    }
}
